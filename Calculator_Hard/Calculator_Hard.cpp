...
// Calculator_Hard.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CCalculatorHardApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CCalculatorHardApp

CCalculatorHardApp::CCalculatorHardApp()
{
...
// Единственный объект CCalculatorHardApp

CCalculatorHardApp theApp;


// Инициализация CCalculatorHardApp

BOOL CCalculatorHardApp::InitInstance()
{
